...
export const newsItems: NewsItem[] = [
  {
    ...
    relatedTenants: ['t1', 't4', 't7'], relatedBuildings: ['b1'],
  },
  {
    ...
    relatedTenants: ['t3', 't4', 't5', 't9', 't11', 't12'], relatedBuildings: ['b2', 'b5', 'b6'],
  },
  {
    ...
    relatedTenants: ['t7', 't2', 't5'], relatedBuildings: ['b3'],
  },
  {
    ...
    relatedTenants: ['t4', 't1', 't5'], relatedBuildings: ['b2'],
  },
  {
    ...
    relatedTenants: ['t6', 't8'], relatedBuildings: ['b3', 'b4'],
  },
  {
    ...
    relatedTenants: ['t1', 't2', 't3'], relatedBuildings: ['b1'],
  },
  {
    ...
    relatedTenants: ['t3', 't9', 't12'], relatedBuildings: ['b1', 'b5'],
  },
  {
    ...
    relatedTenants: ['t9', 't11', 't12', 't13'], relatedBuildings: ['b5', 'b6'],
  },
  {
    ...
    relatedTenants: ['t11', 't12', 't13'], relatedBuildings: ['b6'],
  },
  {
  ...
  },
  {
    ...
    relatedTenants: ['t11', 't12', 't13', 't4', 't9'], relatedBuildings: ['b2', 'b5', 'b6'],
  },
];
