...
const seedTasks: BrokerTask[] = [
  { id: 'task-1', tenantId: 't1', buildingId: 'b1', title: 'Follow up with Sarah Mitchell (McKinsey)', description: 'Call to discuss lease renewal vs relocation. She hasn\'t responded to email.', type: 'follow_up', priority: 'high', dueDate: '2025-03-10', completed: false, createdAt: '2025-03-06T10:30:00Z' },
  { id: 'task-2', tenantId: 't4', buildingId: 'b2', title: 'Call Patricia Wong (Deloitte)', description: 'Second attempt. Try calling before 9am.', type: 'call', priority: 'high', dueDate: '2025-03-11', completed: false, createdAt: '2025-03-04T09:15:00Z' },
  { id: 'task-3', tenantId: 't7', buildingId: 'b3', title: 'Send tour options to Arnold & Porter', description: 'Michelle wants to see Midtown Center, CityCenter, and 1200 17th St.', type: 'email', priority: 'medium', dueDate: '2025-03-10', completed: false, createdAt: '2025-03-03T16:00:00Z' },
  { id: 'task-4', tenantId: 't9', buildingId: 'b5', title: 'Research Class A alternatives for Squire PB', description: 'Find 3-4 buildings with 60-70K SF available, good Metro access, under $70/SF.', type: 'research', priority: 'medium', dueDate: '2025-03-12', completed: false, createdAt: '2025-03-01T10:00:00Z' },
  { id: 'task-5', title: 'Prep weekly pipeline review', description: 'Update all pipeline stages and notes before Friday team meeting.', type: 'other', priority: 'low', dueDate: '2025-03-14', completed: false, createdAt: '2025-03-07T08:00:00Z' },
  { id: 'task-6', tenantId: 't6', buildingId: 'b3', title: 'Meeting with David Park (AWS)', description: 'Discuss expansion needs for GovCloud team. Bring comps for NoMa and East End.', type: 'meeting', priority: 'high', dueDate: '2025-03-13', completed: false, createdAt: '2025-03-05T11:00:00Z' },
  { id: 'task-7', tenantId: 't4', buildingId: 'b2', title: 'Send Deloitte RFP response', description: 'Prepare and send RFP response with 3 building options.', type: 'email', priority: 'medium', dueDate: '2025-03-15', completed: false, createdAt: '2025-03-08T09:00:00Z' },
  { id: 'task-8', tenantId: 't1', buildingId: 'b1', title: 'Tour McKinsey at Midtown Center', description: 'Confirmed tour with building management. Meet Sarah at lobby 2pm.', type: 'meeting', priority: 'low', dueDate: '2025-03-17', completed: false, createdAt: '2025-03-07T14:00:00Z' },
];
